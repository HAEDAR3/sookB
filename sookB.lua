...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or " ميكادو"
SudosS = {1983379011,932319116}
Sudos = {sudoid,932319116,1983379011}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
{{text = '‹ : تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "ميكادو"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/HAEDAR3/sookB/main/sookB.lua -o sookB.lua')
dofile('sookB.lua')  
end
if Text == "UpBot" then
...
{{text = '‹ : CoDeR .',url="https://t.me/A_C_B"},{text = '‹ : TwS .',url="https://t.me/O1VBoT"}},
{{text = '‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .',url="t.me/ZZ7HZ"}},
}
}
...
os.execute('rm -rf sookB.lua')
os.execute('curl -s https://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/uuz02e8tBw@raw.githubusercontent.com/Akainu-sourse/u/main/sookB.lua -o sookB.lua')
dofile('sookB.lua')  
end
end
if text == "تحديث" then
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "ميكادو"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "ميكادو"),"اني لقميل "..(redis:get(bot_id..":namebot") or "ميكادو"),(redis:get(bot_id..":namebot") or "ميكادو").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "ميكادو") then
...
local UserId_Info = bot.searchPublicChat("A_C_B")
if UserId_Info.id then
...
{{text = '‹ : 𝖲??𝗎𝖱??𝖾 𝖾𝗂𝗅𝖺𝗇𝖣 .',url="t.me/ZZ7HZ"}},
}
}
...
ballancee = redis:get(bot_id.."sookB:flotysb"..msg.sender.user_id) or 0
...
mony_list = {}
for k,v in pairs(bank_users) do
local mony = redis:get(bot_id.."sookB:flotysb"..v) or 0
table.insert(mony_list, {tonumber(mony) , v})
end
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
num = 1
...
redis:decrby(bot_id.."sookB:flotysb"..msg.sender.user_id , UserNameyy)
redis:incrby(bot_id.."sookB:flotysb"..Message_Reply.sender.user_id , UserNameyy)
...
alzog = " "..gg.first_name.." "
local zwga_id = redis:get(bot_id..msg.chat_id..msg.sender.user_id.."bnttt2:") 
redis:incrby(bot_id.."sookB:flotysb"..zwga_id,mhrr)
redis:decrby(bot_id.."sookB:flotysb"..msg.sender.user_id,mhrr)
...
gg = "فيزا كارد"
flossst = redis:get(bot_id.."sookB:flotysb"..msg.sender.user_id) or 0
local banid = msg.sender.user_id
redis:set(bot_id.."nonna"..msg.sender.user_id,news)
redis:set(bot_id.."sookBb"..msg.sender.user_id,creditcc)
...
bot.sendText(msg.chat_id,msg.id, "\n⌯ وسوينا لك حساب في البنك ( بنك ميكادو 💳 )  \n\n⌯ رقم حسابك ↢ ( `"..creditcc.."` )\n⌯ نوع البطاقة ↢ ( "..gg.." )\n⌯ فلوسك ↢ ( `"..flossst.."` $ 💸 )  ","md",true)  
end 
...
local banid = msg.sender.user_id
redis:set(bot_id.."nonna"..msg.sender.user_id,news)
redis:set(bot_id.."sookBb"..msg.sender.user_id,creditvi)
redis:set(bot_id.."nnonb"..msg.sender.user_id,text)
redis:set(bot_id.."nnonbn"..msg.sender.user_id,gg)
...
local banid = msg.sender.user_id
redis:set(bot_id.."nonna"..msg.sender.user_id,news)
redis:set(bot_id.."sookBb"..msg.sender.user_id,creditex)
redis:set(bot_id.."nnonb"..msg.sender.user_id,text)
redis:set(bot_id.."nnonbn"..msg.sender.user_id,gg)
...
redis:del(bot_id.."sookBb"..msg.sender.user_id)
...
for k,v in pairs(bank_users) do
redis:del(bot_id.."sookB:flotysb"..v)
...
ballanceed = redis:get(bot_id.."sookB:flotysb"..Remsg.sender.user_id) or 0
...
if redis:sismember(bot_id.."noooybgy",msg.sender.user_id) then
cccc = redis:get(bot_id.."sookBb"..msg.sender.user_id)
...
redis:decrby(bot_id.."sookB:flotysb"..msg.sender.user_id , ballanceekku)
...
ballanceekku = math.floor(coniss / 100 * modarbaa)
ballanceekkku = math.floor(ballancee + ballanceekku)
redis:incrby(bot_id.."sookB:flotysb"..msg.sender.user_id , math.floor(ballanceekku))
redis:setex(bot_id.."nnooooo" .. msg.sender.user_id,1200, true)
...
redis:incrby(bot_id.."sookB:flotysb"..msg.sender.user_id , math.floor(ballanceekk))
...
redis:del(bot_id.."sookB:flotysb"..msg.sender.user_id)
...
redis:incrby(bot_id.."sookB:flotysb"..msg.sender.user_id , math.floor(ballanceek))
redis:setex(bot_id.."nnooo" .. msg.sender.user_id,1200, true)
ff = redis:get(bot_id.."sookB:flotysb"..msg.sender.user_id)
bot.sendText(msg.chat_id,msg.id, "⌯ مبروك فزت بالحظ \n⌯ فلوسك قبل ↢ ( "..ballancee.." $ 💸 )\n⌯ الربح ↢ ( "..ballanceek.." $ 💸 )\n⌯ فلوسك الحين ↢ ( "..ff.." $ 💸 )\n-","md",true)
elseif haddd == 5 or haddd == 6 then
redis:decrby(bot_id.."sookB:flotysb"..msg.sender.user_id , coniss)
redis:setex(bot_id.."nnooo" .. msg.sender.user_id,1200, true)
ff = redis:get(bot_id.."sookB:flotysb"..msg.sender.user_id) or 0
...
redis:incrby(bot_id.."sookB:flotysb"..fsvhhh ,UserNameyy)
redis:decrby(bot_id.."sookB:flotysb"..msg.sender.user_id ,UserNamey)
...
if redis:get(bot_id.."xxxr" .. msg.sender.user_id) then
redis:incrby(bot_id.."sookB:flotysb"..msg.sender.user_id , 3000)
redis:sadd(bot_id.."ttpppi",msg.sender.user_id)
return bot.sendText(msg.chat_id,msg.id,"⌯ خذ بخشيش المحظوظين 3000 $ 💸","md",true)
end
local jjjo = math.random(1,2000);
redis:incrby(bot_id.."sookB:flotysb"..msg.sender.user_id , jjjo)
redis:sadd(bot_id.."ttpppi",msg.sender.user_id)
...
ballanceed = redis:get(bot_id.."sookB:flotysb"..UserId_Info.id) or 0
bot.sendText(msg.chat_id,msg.id, "⌯ فلوسه "..ballanceed.." $ 💸","md",true)
else
...
local ballanceed = redis:get(bot_id.."sookB:flotysb"..Remsg.sender.user_id) or 0
redis:incrby(bot_id.."sookB:flotysb"..msg.sender.user_id , hrame)
redis:decrby(bot_id.."sookB:flotysb"..Remsg.sender.user_id , hrame)
redis:sadd(bot_id.."ttpppi",msg.sender.user_id)
...
K = 'محظوظ 2x' 
F = '15000'
redis:incrby(bot_id.."sookB:flotysb"..msg.sender.user_id , F)
local ballancee = redis:get(bot_id.."sookB:flotysb"..msg.sender.user_id) or 0
local teex = 
...
local Text = "*‹ : WeLCoMe To sookB TEaM  .*\n"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .',url="https://t.me/ZZ7HZ"}},
{{text = '‹ : inFo sookB  .',url="https://t.me/ZZ7HZ"}},
{{text = '‹ : CoDeR .',url="https://t.me/A_C_B"},{text = '‹ : TwS .',url="https://t.me/A_C_B"}},
}
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/ZZ7HZ&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
----------------------------------------------------------------------------------------------------
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
