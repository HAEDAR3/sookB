...
--download('https://github.com/Mohmmedrg/NIGHTMARE/blob/main/sookB.lua','sookB.lua')
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.sookBchat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس  Mac',url="t.me/ZZ7HZ"}}
}
local msg_id = msg.id/2097152/0.5
