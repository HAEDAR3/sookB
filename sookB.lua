------------------------------------------------
-- This Source Was Developed By (sookB) @A_C_B.--
--   This Is The Source Channel @A_C_B .   --
--                - sookB -                 --
--        -- https://t.me/A_C_B --         --
------------------------------------------------ 
...
LuaTele = luatele.set_config{api_id=6877733,api_hash='0d0d6f66a34f26af1693cd16169dea04',session_name=ThesookB,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,932319116,932319116}  
...
Status = Redis:get(ThesookB.."sookB:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(ThesookB.."sookB:PresidentQ:Group:Reply"..ChatId) or 'المالك'
...
return {
Lock     = '[‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .](https://t.me/ZZ7HZ)\n*——–——–——–——–\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .](https://t.me/ZZ7HZ)\n*——–——–——–——–\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .](https://t.me/ZZ7HZ)\n*——–——–——–——–\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .](https://t.me/ZZ7HZ)\n*——–——–——–——–\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .](https://t.me/ZZ7HZ)\n*——–——–——–——–\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .](https://t.me/ZZ7HZ)\n*——–——–——–——–\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
msg.Name_Controller = 'مطوࢪ السورس '
msg.The_Controller = 1
...
msg.Name_Controller = Redis:get(ThesookB.."sookB:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
...
if not msg.Distinguished then  -- الكيبورد ال start
...
Redis:incr(ThesookB.."sookB:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
...
Redis:incr(ThesookB.."sookB:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
{
{text = '‹ 𝖳𝖾𝖠𝗆 𝘟𝗑 › .', url='https://t.me/ZZ7HZ'},
},
}
}
...
if Redis:get(ThesookB.."sookB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ᥀︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(ThesookB.."sookB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(ThesookB.."sookB:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(ThesookB.."sookB:Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(ThesookB..'sookB:Channel:Join')}, },}}
...
download('https://raw.githubusercontent.com/https:/HAEDAR3/sookB/master/sookB','sookB.lua')
...
Redis:del(ThesookB.."sookB:SendBcBot") 
...
Redis:set(ThesookB.."sookB:SendBcBot",true) 
...
Redis:del(ThesookB.."sookB:LeftBot") 
...
Redis:set(ThesookB.."sookB:LeftBot",true) 
...
Redis:srem(ThesookB.."sookB:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if text and text:match('^بحث (.*)$') and Redis:get(ThesookB.."sookB:Status:yt"..msg.chat_id) then
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/ZZ7HZ'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ᥀︙ عليك الاشتراك في قناة البوت لاستخدام الاوامر*',"md",false, false, false, false, reply_markup)
end
local UserId_Info = LuaTele.searchPublicChat(UserName)
if not UserId_Info.id then
...
if Controller(msg_chat_id,UserId_Info.id) == 'مبࢪمج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'مبࢪمج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'مطوࢪ السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Redis:sismember(ThesookB.."sookB:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(ThesookB.."sookB:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(ThesookB.."sookB:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(ThesookB.."sookB:ktmAll:Groups",UserId_Info.id) 
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبࢪمج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مبࢪمج السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'مطوࢪ السورس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 』*","md",true)  
end
if Redis:sismember(ThesookB.."sookB:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(ThesookB.."sookB:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(ThesookB.."sookB:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(ThesookB.."sookB:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if #bank_users == 0 then
return bot.sendText(msg.chat_id,msg.id,"⌯ لا يوجد متزوجين بالكروب","md",true)
end
...
bot.sendText(msg.chat_id,msg.id, "\n⌯ وسوينا لك حساب في البنك ( بنك اكس 💳 )  \n\n⌯ رقم حسابك ↢ ( `"..creditcc.."` )\n⌯ نوع البطاقة ↢ ( "..gg.." )\n⌯ فلوسك ↢ ( `"..flossst.."` $ 💸 )  ","md",true)  
end 
...
bot.sendText(msg.chat_id,msg.id,[[
 - اهلا بك في لعبه البنك اختر امر من الاوامر .
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
᥀︙انشاء حساب بنكي - تكدر تسوي حساب بالبنك وتجمع فلوس وشياء اخره
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
᥀︙مسح حساب بنكي - تحذف حسابك البنكي
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
᥀︙حسابي - علمود يطلع معلومات حسابك مثل ايديك ومصرفك وفلوسك
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
᥀︙ فلوسي - يطلعلك شكد فلوسك
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
᥀︙راتب - يطيك راتب كل 10 دقايق
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
᥀︙بخشيش - يطيك بخشيش كل 10 دقايق
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
᥀︙تسليب - تسرق الشخص كل 10 دقايق
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
...
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
᥀︙توب المتزوجين - يطلع اغلى ٢٠ زواجات
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _
...
return bot.sendText(msg.chat_id,msg.id, "⌯ مايمديك تزرفه فلوسه اقل من 1000  $ 💸","md",true)
end
...
Redis:setex(ThesookB.."sookB:Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ᥀︙ ارسل الان النص
 ᥀︙ يمكنك اضافه :
...
Redis:del(ThesookB.."sookB:Set:Id:Groups")
...
if text == 'مبرمج سورس' or text == 'مبࢪمج السورس' or text == 'المبرمج' then  
...
if Redis:get(ThesookB.."sookB:Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(ThesookB.."sookB:Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
{
{text = 'Annotations Source', url = 't.me/ZZ7HZ'}, 
},
{
{text = 'Communication Source', url = 't.me/Dragonbotqrintestbot'}, 
},
{
{text = 'Developer Source .', url = 't.me/A_C_B'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
if not Redis:get(ThesookB.."sookB:Sasa:Jeka"..msg_chat_id) then
...
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
"لتــلح دا احجي ويه بنات اكس بعدين اجاوبك",
...
GroupAllRtba = Redis:hgetall(sookB..':GroupUserCountMsg:groups')
GetAllNames  = Redis:hgetall(sookB..':GroupNameUser:groups')
GroupAllRtbaL = {}
...
if Redis:get(Thestart.."start:Status:Games"..msg.chat_id) then
Redis:del(Thestart.."Set:Country"..msg.chat_id)
...
Redis:set(Thestart.."Game:Countrygof"..msg.chat_id,name)
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(ThesookB.."sookB:Name:Bot") or "اكس")..
...
data = {
{
{text = '᥀ السورس .', url = 't.me/ZZ7HZ'},{text = '᥀ لتنصيب بوت .', url = 't.me/A_C_B'}, 
},
{
...
function CallBackLua(data) --- كول باك الابديت عوفه مهم هذ
--var(data) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(ThesookB.."sookB:Sasa:Jeka"..ChatId) 
